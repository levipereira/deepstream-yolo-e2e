...
URLs["libnvinfer_plugin.so.10.9.0.x86_64"]="https://github.com/levipereira/deepstream-yolo-e2e/releases/download/v1.0/libnvinfer_plugin.so.10.9.0.x86_64"
...
URLs["libnvinfer_plugin.so.10.9.0.aarch64"]="https://github.com/levipereira/deepstream-yolo-e2e/releases/download/v1.0/libnvinfer_plugin.so.10.9.0.aarch64"
